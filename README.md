...
A clean, lightweight frontend posting and management dashboard designed for authors and content creators in WordPress.
...
1. Upload the plugin folder to the `/wp-content/plugins/` directory, or install the ZIP directly via **Plugins -> Add New -> Upload Plugin**.
2. Activate the plugin through the **Plugins** menu in WordPress.
3. Place the shortcode `[frontend_post_dashboard]` on any page.
